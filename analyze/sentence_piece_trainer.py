...
print(sp.encode_as_pieces("Tokenization is crucial for AI models."))


# (myenv) harish:analyze $ python sentence_piece_trainer.py 
...
# trainer_interface.cc(687) LOG(INFO) Saving model: custom_tokenizer.model
# trainer_interface.cc(699) LOG(INFO) Saving vocabs: custom_tokenizer.vocab
# ['▁T', 'okeniz', 'at', 'i', 'o', 'n', '▁i', 's', '▁c', 'r', 'u', 'c', 'i', 'al', '▁', 'f', 'or', '▁', 'A', 'I', '▁model', 's', '.']
